...
class Bauer
{
  ...
  public function setDato($d, $m) : bool
  {
  	...
  	switch($this->ajtal - $this->pjtal)
  	{
  		...
  		case  -21: $this->description = ["4. S i Fasten", "Dom Laetare", "<h6>4. Søndag i Fasten</h6><p class='text-left'>Dom. de Fontanis<br>Dom. Laetare</p>"];
  							 break;
  	  ...
  	  case   49: $this->description = ["Pinsedag", "Dom Pentecostes", ""];
  	  					 break;

  	  case   50: $this->description = ["2. Pinsedag", "Dies Pentecostes", ""];
  		           $this->adatoClass=3;
  	  					 break;
  	  ...
  	  case   56: $this->description = ["Trinitatis", "Dom Trinitatis", ""];
  	             break;
  	...
  	switch ($d * 100 + $m )
  	{
  		...
  		case  111: if ($this->aar < 1771)
  		           { 
  								 $this->description = ["Allehelgensdag", "Festum omnium sanctorum", ""];
  		             $this->adatoClass=3;
  		           }
  		           break; 
 	          
  		case 1111: if ($this->aar < 1771)
  		           { 
  								 $this->description = ["Mortensdag", "Martinus ep. conf", ""];
  		             $this->adatoClass=3;
  		           }
  		           break; 

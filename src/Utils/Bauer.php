  ...
  public function setDato($d, $m) : bool
  {
  	...
  	switch($this->ajtal - $this->pjtal)
  	{
  	  ...
  	  case    2: if ($this->aar < 1771)
  	             { 
  	  						 $this->description = ["3. Påskedag", "", "<h6>3. Påskedag<h6><p>Helligdag frem til 1770</p>"];
  		             $this->adatoClass=3;
  		           }  
  	  					 break;
  	  ...
  	  case   51: if ($this->aar < 1771)
  	             {
  	               $this->description = ["3. Pinsedag", "", "<h6>3. Pinsedag</h6><p>Helligdag frem til 1770</p>"];
  		             $this->adatoClass=3;
  		           }
  	  					 break;
  	...
  	switch ($d * 100 + $m )
  	{
  		...
  		case  501: $this->description = ["Hellig 3 konger", "Dom Epiphanias", "<h6>Helligtrekonger</h6><p>Dom. Baptismus Christi<br>Dom. Ephiphania</p><p>Helligdag frem til 1770<p>"];
  				   if ($this->aar < 1771)
  		             $this->adatoClass=3;
  		           break;
  		...
  		case  202: $this->description = ["Kyndelmisse", "Purificatio Mariae", "<h6>Kyndelmisse</h6><p class='text-left'>Maria renselsesdag<br>Dies Mariae Cerealis<br>Dies Praesentatio Domini<br>Dom. Purificatio Mariae Virginis</p><p>Helligdag frem til 1770</p>"];
  		           if ($this->aar < 1771)
  		             $this->adatoClass=3;
  		           break;
  		...
  		case 2503: if ($this->aar < 1771)
  		            $this->description = ["Maria bebudelse", "Annuntiatio Mariae Virginis", "<h6>Maria Bebudelse</h6><p class='text-left'>Annuntiatio Mariae Virginis<br>Dies Evangelismi<br>Dies Incarnationis<br>Dies Salutationis</p><p>Helligdag frem til 1770</p>"];
  		            $this->adatoClass=3;
  		           break;	
  		...
  		case 2406: $this->description = ["Sct Hans", "Fest Nat St Johs Baptistae", "<h6>Sct Hans</h6><p class='text-left'>Midsommer<br>Festum Nativitas St. Johannis Baptistae</p><p>Helligdag frem til 1770</p>"];
  							 if ($this->aar < 1771)
  		             $this->adatoClass=3;
  		           break; 
  		...
  		case  207: if ($this->aar < 1771)
  		           { 
  								 $this->description = ["Mariæ besøgelsesdag", "Visitationes Mariae", "<h6>Mariæ besøgelsesdag</h6><p class='text-left'>Visitationes Mariae</p><p>Helligdag frem til 1770</p>"];
  		             $this->adatoClass=3;
  		           }
  		           break; 
  		...
  		case 2909: if ($this->aar < 1771)
  		           { 
  								 $this->description = ["Mikkelsdag", "Festum archangeli Michaelis", ""];
  		             $this->adatoClass=3;
  		           }
  		           break; 
  		...
  		case  111: $this->description = ["Allehelgensdag", "Festum omnium sanctorum", "<h6>Allehelgensdag</h6><p>Festum omnium sanctorum</p><p>Helligdag frem til 1770</p>"];
								 if ($this->aar < 1771)
  		           { 
  								 $this->adatoClass=3;
  		           }
  		...
  		case 1111: $this->description = ["Mortensdag", "Martinus ep. conf", "<h6>Mortens dag</h6><p class='text-left'>Morten Bisp<br>Martinus ep. conf.</p><p>Helligdag frem til 1770</p>"];
								 if ($this->aar < 1771)
  		           { 
  								 $this->adatoClass=3;
  		           }
  	...
  	if ($this->_getUgedag() == 6)
  	{
  		...
  		switch(intdiv($dummy, 7))
  		{
  			...
  			case 3: $this->description= ["1. S i Advent", "Dom Adventus", ""];
  			        break;
  		}
  	}
